...
CONTRACT bloodwarriorcode : public contract
{
public:
  ...
  /**
   *
   *  Saves the info related with a bloodwarrior within a community
   *
   * @param account - The user account name,
   * @param bloodwarrior_name - The name of the life bank
  ...
  /**
   *
   *  TODO: que hace upBloodwarrior???
   *
   * @param account - The user account name,
   * @param bloodwarrior_name - The name of the life bank
   * @param about - blood bank's about
   * @param address - blood bank's address
   * @param location - blood banks's location latitud,logitud
   * @param telephones - blood banks' phone_number
   * @param has_immunity_test - TODO:
   * @param blood_urgency_level - TODO:
   * @param schedule - blood banks's schedule
   * @param community_asset - Symbol ex: 1 SYS , 1 BLOOD
   * @param email - blood bank's email
   * @param photos - blood bank's photos
   * @param logo_url - blood bank's logo
   * @param social_media_links - blood bank's social media links
   * @param requirement - blood bank's requirement
   *
   * @pre community's symbol must exits
   *
   */
  ACTION upbloodwarrior
      name account,
      string bloodwarrior_name,
      string about,
      string address,
  ...
  */
  ...
  /*
  *  Table to store data realted with bloodwarrior offers
  */
  TABLE bloodwarrior_offers
  {
    uint64_t id;
    name offer_name;
    ...
    EOSLIB_SERIALIZE(bloodwarrior_offers, (id)(offer_name)(community));
  };
  typedef eosio::multi_index<
      name("commoffer"), bloodwarrior_offers, eosio::indexed_by<
        name("offername"), eosio::const_mem_fun<
            bloodwarrior_offers, uint64_t, &bloodwarrior_offers::by_secondary
          >
        >
      > bloodwarrior_offers_table;
...
private:
  ...
  /**
   *
   *  Verify is an account is a bloodwarrior
   *
   * @param account - The user account name
   *
   * @return true is the account is a bloodwarrior, otherwise returns false
   */
  bool is_bloodwarrior(name account);
  ...
  */
  ...
  /*
  *
  *  Table to store data realted with bloodwarriors
  */
  TABLE bloodwarrior
  {
    name account;
