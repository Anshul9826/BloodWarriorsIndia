    ...
    <>
      {!localStorage.getItem("token") ? (
        ...
        <div className="formStyle d-flex flex-column align-items-center py-4">
          ...
          <form className="donationForm mx-5 p-4" onSubmit={handleSubmit}>
            <h2>BLOOD DONOR QUESTIONNAIRE & CONSENT FORM</h2>
            <ol className="my-2">
              <div className="row">
              ...
              <div className="row">
                <li className="donor col">
                  ...
                  either Hepatits,Malaria,HIV/AIDS and /or venereal disease?
                </li>
                <div className="form-check col-md-1">
                  <input
                    className="form-check-input"
              ...
              <ol type="a">
                <li>
                  ...
                  answered all the question truthfully, as any incorrect
                ...
                <div className="form-check col">
                  ...
                  >
                    ...
                    that by donation voluntarily, I accept the risks associated
                    with this procedure.
                  </label>
                </div>
                <div className="form-check col">
                  ...
                  >
                    ...
                    HIV/AIDS and veneral disease in addition to any other
                    screening tests required to ensured blood safety.
                  </label>
                </div>
              </ol>
            </ol>
